...
-- Live world renderer for the ESP Builder layout (use in your own Roblox experience).
-- local renderer = window:CreateESPWorldRenderer({
--     Builder = espBuilder, -- automatically follows every builder change
--     MaxDistance = 1000,
--     TeamCheck = false,
--     VisibleCheck = false,
-- })
