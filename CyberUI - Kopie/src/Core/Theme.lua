...
local stylePresets = {
    Vaxorin = {
        ...
        Secondary = Color3.fromRGB(11, 14, 21),
        Surface = Color3.fromRGB(15, 18, 27),
        SurfaceHover = Color3.fromRGB(22, 25, 36),
        ElementBackground = Color3.fromRGB(14, 17, 24),
        ElementHover = Color3.fromRGB(21, 24, 33),
        Text = Color3.fromRGB(245, 246, 250),
        TextMuted = Color3.fromRGB(151, 157, 174),
        Border = Color3.fromRGB(39, 44, 57),
        BorderStrong = Color3.fromRGB(58, 64, 82),
        Accent = Color3.fromRGB(173, 76, 255),
        AccentAlt = Color3.fromRGB(104, 112, 255),
        AccentSoft = Color3.fromRGB(120, 58, 190),
    },
    Dark = {
