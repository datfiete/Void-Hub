...
local Window = Rayfield:CreateWindow({
   Name = "Dice Rolling Incremental",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "Dice Rolling Incremental script",
   LoadingSubtitle = "by Datfeite",
   ShowText = "Dice Rolling Incremental", -- for mobile users to unhide Rayfield, change if you'd like
