...
local islands = {
    ...
    {Name = "Snow Trooper",       Min = 1000, Max = 1049, Pos = Vector3.new(483, 411, -5425), Quest = {"StartQuest","SnowQuest2",1}, EnemyPatterns = {"Snow Trooper"}, isBoss = false},
    {Name = "Winter Warrior",     Min = 1050, Max = 1099, Pos = Vector3.new(1216, 429, -5307), Quest = {"StartQuest","SnowQuest2",2}, EnemyPatterns = {"Winter Warrior"}, isBoss = false},
    {Name = "Lab Subordinate",    Min = 1100, Max = 1124, Pos = Vector3.new(-5821, 84, -4409), Quest = {"StartQuest","IceQuest",1}, EnemyPatterns = {"Lab Subordinate"}, isBoss = false},
    {Name = "Horned Warrior",     Min = 1125, Max = 1174, Pos = Vector3.new(-6342, 29, -5818), Quest = {"StartQuest","FireQuest",1}, EnemyPatterns = {"Horned Warrior"}, isBoss = false},
    {Name = "Magma Ninja",        Min = 1175, Max = 1199, Pos = Vector3.new(-5784, 37, -5559), Quest = {"StartQuest","FireQuest",2}, EnemyPatterns = {"Magma Ninja"}, isBoss = false},
    {Name = "Lava Pirate",        Min = 1200, Max = 1249, Pos = Vector3.new(-5078, 29, -4934), Quest = {"StartQuest","FireQuest",3}, EnemyPatterns = {"Lava Pirate"}, isBoss = false},
    ...
    {Name = "Jeremy",             Min = 850, Max = 875, Pos = Vector3.new(2338, 451, 700),
        ...
        isBoss = true},
    {Name = "Don Swan",           Min = 1000, Max = 1050, Pos = Vector3.new(2290, 18, 663),
        Quest = {"StartQuest","Area2Quest",2}, EnemyPatterns = {"Factory Staff"},
        BossQuest = {"StartQuest","Area2Quest",3}, BossPatterns = {"Don Swan"},
        isBoss = true},
    {Name = "Smoke Admiral",      Min = 1150, Max = 1200, Pos = Vector3.new(-4857, 234, -5583),
        Quest = {"StartQuest","IceQuest",1}, EnemyPatterns = {"Lab Subordinate"},
        BossQuest = {"StartQuest","IceQuest",3}, BossPatterns = {"Smoke Admiral"},
        isBoss = true},
